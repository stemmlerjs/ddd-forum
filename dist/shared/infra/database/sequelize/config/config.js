...
const { DDD_FORUM_DB_USER, DDD_FORUM_DB_PASS, DDD_FORUM_DB_HOST, DDD_FORUM_DB_DEV_DB_NAME, DDD_FORUM_DB_TEST_DB_NAME, DDD_FORUM_DB_PROD_DB_NAME, NODE_ENV, DDD_FORUM_IS_PRODUCTION, CLEARDB_DATABASE_URL } = process.env;
